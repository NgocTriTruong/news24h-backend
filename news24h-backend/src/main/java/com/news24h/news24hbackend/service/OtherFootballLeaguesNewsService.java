...
@Service
public class OtherFootballLeaguesNewsService {
    private final NewsArticleRepository newsRepository;
    private final ArticleCrawlerService crawlerService;
    private final ThumbnailUpdateService thumbnailUpdateService;

    public OtherFootballLeaguesNewsService(NewsArticleRepository newsRepository,
    ...
    public List<NewsArticle> crawlOtherLeaguesNews() {
        List<NewsArticle> articles = new ArrayList<>();
        try {
            String url = "https://www.24h.com.vn/cac-giai-bong-da-khac-c315.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin các giải bóng đá khác");
                            article.setThumbnail(thumbnail);
                            article.setCategory("cac-giai-bong-da-khac");
            ...
            System.err.println("Lỗi crawl cac-giai-bong-da-khac: " + e.getMessage());
        }
        if (!articles.isEmpty()) {
    ...
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin các giải bóng đá khác tự động...");
        crawlOtherLeaguesNews();
    }
}
