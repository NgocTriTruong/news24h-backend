...
public class FootballBriefNewsService {
    ...
    public List<NewsArticle> crawlFootballBriefNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/tin-van-bong-da-c409.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Điểm tin bóng đá");
                            article.setThumbnail(thumbnail);
                            article.setCategory("diem-tin-bong-da");
            ...
            System.err.println("Lỗi crawl diem-tin-bong-da: " + e.getMessage());
        }
    ...
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl Điểm tin bóng đá tự động...");
        crawlFootballBriefNews();
    }
}
