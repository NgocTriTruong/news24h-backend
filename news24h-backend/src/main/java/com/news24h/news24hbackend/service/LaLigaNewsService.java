...
public class LaLigaNewsService {
    ...
    public List<NewsArticle> crawlLaLigaNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/bong-da-tay-ban-nha-c151.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức La Liga - Bóng đá Tây Ban Nha");
                            article.setThumbnail(thumbnail);
                            article.setCategory("la-liga");
            ...
            System.err.println("Lỗi crawl la-liga: " + e.getMessage());
        }
    ...
    @Scheduled(fixedRate = 43200000, initialDelay = 115000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin La Liga tự động...");
        crawlLaLigaNews();
    }
}
