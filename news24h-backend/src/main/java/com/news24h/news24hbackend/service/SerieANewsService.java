...
public class SerieANewsService {
    ...
    public List<NewsArticle> crawlSerieANews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/bong-da-y-c150.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức Serie A - Bóng đá Ý");
                            article.setThumbnail(thumbnail);
                            article.setCategory("serie-a");
            ...
            System.err.println("Lỗi crawl serie-a: " + e.getMessage());
        }
    ...
    @Scheduled(fixedRate = 43200000, initialDelay = 110000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin Serie A tự động...");
        crawlSerieANews();
    }
}
