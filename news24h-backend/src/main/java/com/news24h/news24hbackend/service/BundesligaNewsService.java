...
public class BundesligaNewsService {
    ...
    public List<NewsArticle> crawlBundesligaNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/bong-da-duc-c152.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức Bundesliga - Bóng đá Đức");
                            article.setThumbnail(thumbnail);
                            article.setCategory("bundesliga");
            ...
            System.err.println("Lỗi crawl bundesliga: " + e.getMessage());
        }
    ...
    /**
     * Tự động crawl mỗi 12 giờ, crawl ngay sau 105 giây khởi động
     */
    @Scheduled(fixedRate = 43200000, initialDelay = 105000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin Bundesliga tự động...");
        crawlBundesligaNews();
    }
}
