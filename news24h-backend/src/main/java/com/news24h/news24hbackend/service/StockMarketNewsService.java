...
public class StockMarketNewsService {
    ...
    public StockMarketNewsService(NewsArticleRepository newsRepository,
    ...
    public List<NewsArticle> crawlStockMarketNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/tin-chung-khoan-c566.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức Chứng khoán");
                            article.setThumbnail(thumbnail);
                            article.setCategory("chung-khoan");
            ...
            System.err.println("Lỗi crawl chung-khoan: " + e.getMessage());
        }
    ...
    /**
     * Tự động crawl mỗi 12 giờ, crawl ngay sau 75 giây khởi động
     */
    @Scheduled(fixedRate = 43200000, initialDelay = 75000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin Chứng khoán tự động...");
        crawlStockMarketNews();
    }
}
