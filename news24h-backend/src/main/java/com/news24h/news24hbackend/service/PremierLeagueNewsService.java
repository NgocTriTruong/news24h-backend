...
public class PremierLeagueNewsService {
    ...
    public List<NewsArticle> crawlPremierLeagueNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/bong-da-ngoai-hang-anh-c149.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức Ngoại hạng Anh - Premier League");
                            article.setThumbnail(thumbnail);
                            article.setCategory("ngoai-hang-anh");
            ...
            System.err.println("Lỗi crawl ngoai-hang-anh: " + e.getMessage());
        }
    ...
    @Scheduled(fixedRate = 43200000, initialDelay = 100000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin Ngoại hạng Anh tự động...");
        crawlPremierLeagueNews();
    }
}
