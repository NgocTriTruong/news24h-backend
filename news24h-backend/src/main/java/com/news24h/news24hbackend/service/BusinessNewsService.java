...
public class BusinessNewsService {
    ...
    public BusinessNewsService(NewsArticleRepository newsRepository,
    ...
    public List<NewsArticle> crawlBusinessNews() {
        List<NewsArticle> articles = new ArrayList<>();

        try {
            String url = "https://www.24h.com.vn/doanh-nghiep-c849.html";
                ...
                try {
                    ...
                    if (!title.isEmpty() && title.length() > 10 &&
                        ...
                        if (newsRepository.findBySourceUrl(href).isEmpty()) {
                            ...
                            article.setDescription("Tin tức Doanh nghiệp");
                            article.setThumbnail(thumbnail);
                            article.setCategory("doanh-nghiep");
            ...
            System.err.println("Lỗi crawl doanh-nghiep: " + e.getMessage());
        }
    ...
    @Scheduled(fixedRate = 43200000, initialDelay = 65000)
    public void scheduledCrawl() {
        System.out.println("Bắt đầu crawl tin Doanh nghiệp tự động...");
        crawlBusinessNews();
    }
}
